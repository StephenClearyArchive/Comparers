...
namespace EqualityComparers
{
    ...
    /// <summary>
    /// Provides sources for equality comparers, automatically deriving the type of objects to be compared from an instance of that type.
    /// </summary>
    public static class EqualityCompare
    {
        /// <summary>
        /// Gets the null equality comparer for the specified type, which evaluates all objects as equivalent.
        /// </summary>
        /// <typeparam name="T">The type of objects being compared.</typeparam>
        /// <param name="instance">An instance of the type to compare. This may be <c>null</c>.</param>
        public static IEqualityComparer<T> Null<T>(T instance)
        {
            Contract.Ensures(Contract.Result<IEqualityComparer<T>>() != null);
        ...
        /// <summary>
        /// Gets the default equality comparer for the specified type.
        /// </summary>
        /// <typeparam name="T">The type of objects being compared.</typeparam>
        /// <param name="instance">An instance of the type to compare. This may be <c>null</c>.</param>
        public static IEqualityComparer<T> Default<T>(T instance)
        {
            Contract.Ensures(Contract.Result<IEqualityComparer<T>>() != null);
        ...
        /// <summary>
        /// Gets the reference equality comparer for the specified type.
        /// </summary>
        /// <typeparam name="T">The type of objects being compared.</typeparam>
        /// <param name="instance">An instance of the type to compare. This may be <c>null</c>.</param>
        public static IEqualityComparer<T> Reference<T>(T instance)
        {
            Contract.Ensures(Contract.Result<IEqualityComparer<T>>() != null);
        ...
        /// <param name="keyComparer">The key comparer. Defaults to <c>null</c>. If this is <c>null</c>, the default comparer is used.</param>
        /// <param name="allowNulls">A value indicating whether <c>null</c> values are passed to <paramref name="selector"/>. If <c>false</c>, then <c>null</c> values are considered less than any non-<c>null</c> values and are not passed to <paramref name="selector"/>.</param>
        public static IEqualityComparer<T> EquateBy<T, TKey>(T instance, Func<T, TKey> selector, IEqualityComparer<TKey> keyComparer = null, bool allowNulls = false)
        {
            Contract.Requires(selector != null);
            Contract.Ensures(Contract.Result<IEqualityComparer<T>>() != null);
            return EqualityCompare<T>.EquateBy<TKey>(selector, keyComparer, allowNulls);
        }
    }
}