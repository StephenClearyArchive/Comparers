...
namespace EqualityComparers
{
    ...
    public static class EqualityComparerExtensions
    {
        ...
        public static IEqualityComparer<T> ThenBy<T>(this IEqualityComparer<T> source, IEqualityComparer<T> thenBy)
        {
        ...
        public static IEqualityComparer<T> ThenBy<T, TKey>(this IEqualityComparer<T> source, Func<T, TKey> selector, IEqualityComparer<TKey> keyComparer = null, bool allowNulls = false)
        {
        ...
        public static IEqualityComparer<IEnumerable<T>> Sequence<T>(this IEqualityComparer<T> source)
        {
            Contract.Ensures(Contract.Result<IEqualityComparer<T>>() != null);
